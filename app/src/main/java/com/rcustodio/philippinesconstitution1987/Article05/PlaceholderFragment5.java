...
public class PlaceholderFragment5 extends Fragment {
    ...
    private PageViewModel5 pageViewModel;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        pageViewModel = ViewModelProviders.of(this).get(PageViewModel5.class);
        int index = 1;
    ...
    public View onCreateView(
        ...
        View root = inflater.inflate(R.layout.fragment_article05, container, false);
