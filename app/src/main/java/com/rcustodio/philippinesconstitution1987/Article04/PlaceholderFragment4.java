...
public class PlaceholderFragment4 extends Fragment {
    ...
    private PageViewModel4 pageViewModel;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        pageViewModel = ViewModelProviders.of(this).get(PageViewModel4.class);
        int index = 1;
    ...
    public View onCreateView(
        ...
        View root = inflater.inflate(R.layout.fragment_article04, container, false);
