...
public class PlaceholderFragment3 extends Fragment {
    ...
    private PageViewModel3 pageViewModel;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        pageViewModel = ViewModelProviders.of(this).get(PageViewModel3.class);
        int index = 1;
    ...
    public View onCreateView(
        ...
        View root = inflater.inflate(R.layout.fragment_article03, container, false);
